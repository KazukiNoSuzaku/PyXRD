...
def load(tkreg):
    # Load adapters (registering happens via AdapterRegistry.register in metaclasses)
    ...
    # Load tree view adapters
    from .tree_view_adapters import (
        ObjectListViewAdapter, XYListViewAdapter, ObjectTreeViewAdapter
    )
